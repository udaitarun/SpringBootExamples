...
public class EmployeeController {
	...
	@GetMapping("/findByEnameAndEsal/{ename}/{esal}")
	public List<Employee> findByEnameAndEsal(@PathVariable String ename,@PathVariable Double esal){
		return employeeService.findByEnameAndEsal(ename, esal);
	}
